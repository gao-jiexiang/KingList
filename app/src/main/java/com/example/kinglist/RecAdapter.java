...
public class RecAdapter extends RecyclerView.Adapter<RecAdapter.ViewHolder> {
    ...
    public RecAdapter(Context mContext, ArrayList<VideoBean.ListBean> mVideo) {
    ...
    public RecAdapter setOnItemLongClickListener(OnItemLongClickListener onItemLongClickListener) {
